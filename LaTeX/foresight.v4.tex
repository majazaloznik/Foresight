...
\centering
\caption{Labour market participation rates in the United Kingdom for both genders and women only, 1994-2014, based on 4 quarter rolling averages(see Figure \ref{Fig:58}). Source: \citet{ONS2015a}.}
...
\centering
\caption{Employment rates by age group for OECD countries (2014 data) and G20 countries (2013 data) (see Figure \ref{Fig:OECD}). Source: \citet{OECD2015}.}
...
Indonesia   & 70.0 & 62.0 & 37.0 \\ 
  ...
  Russia & 61.7 & 30.2 & \multicolumn{1}{c}{n.a.} \\ 
...
\centering
\caption{Percentage point difference in employment rate of older workers (aged 55--64) 2004--2014 in OECD and G20 countries (see Figure \ref{Fig:OECD2}). Source: \citet{OECD2015}.}
\begin{tabularx}\textwidth{>{\small\em}p{4cm}
  *2{>{\centering\arraybackslash\small}X<{ \%}} >{\centering\arraybackslash}X@{}}
\hline
\multirow{2}{*}{Country} & \multicolumn{1}{c}{\emph{Employment}} & \multicolumn{1}{c}{\emph{Employment }} & \emph{Difference} \\ 
& \multicolumn{1}{c}{\emph{ rate in 2014}} & \multicolumn{1}{c}{\emph{ rate in 2004}} & \emph{(percentage points)} \\ 
  \hline
...
As can be seen from Figure \ref{Fig:57} the economic activity of men is predicted to stay relatively stable with only small fluctuations\footnote{This analysis was done before the Pensions Act of 2011 and is therefore based on the SPA being equalised to 65 by 2020 instead of 66 as it currently stands. }. Women's rates have been rising as more active cohorts age, and furthermore their levels of economic activity in the over 60 age group are also predicted to rise due to the rise in state pension eligibility age. The table below also shows working aged men's economic activity falling by about five percentage points, while women's is predicted to rise by about the same amount in this period. 


\begin{table}[hbtp!]

\caption{Estimates and projections of economic activity (percent employed) for men and women of working age and state pension age; United Kingdom; 1990 to 2020 (see Figure \ref{Fig:57}). Source \citet{Mad2006}.}\label{Tab:54}
\centering
\begin{tabularx}\textwidth{p{2cm} *4{>{}X<{\raggedleft \enspace \%}}@{}}
  \hline
\multirow{2}{*}{\emph{Year}}& \multicolumn{2}{c}{\emph{Males}} & \multicolumn{2}{c}{\emph{Females}}\\  
\cline{2-5}
...
\caption{Profile of tenure of housing occupied by households headed by an individual aged 65 and over (\%), England only, 2003/04 to 2013/14. Source: data from Annex Table 1.4 in  \citet{DCLG2015}.}\label{Fig:16} %source ok
\end{figure}
...
\caption{Proportion of households headed by an individual aged 65 and over in rented tenures, 2003/04 to 2013/14, England only. Source: data from Annex Table 1.4 in  \citet{DCLG2015}.}\label{Fig:17} % source ok
\end{figure}
...
\caption{Profile of housing tenure occupied by households headed by an individual aged 65 and over (\% in each tenure type), England only (see Figures \ref{Fig:16} and \ref{Fig:17}). Source: data from Annex Table 1.4 in  \citet{DCLG2015}.}\label{Tab:61}
\centering
\begin{tabularx}\textwidth{>{\em}l *6{>{\centering\arraybackslash}X<{ \%}}@{}}

\hline
& \multicolumn{6}{c}{\emph{Tenure type}}\\
\cline{2-7}
  \\ [-1em]
Year & \multicolumn{1}{c}{\rotatebox{90}{\emph{Own outright}}}
...
\caption{Percentage of houses failing the decent homes criteria by reason for failyre -– households occupied by an individual over 60. Source: Table DA3203 from the English Housing Survey \citep{DCLG2013}.}\label{Fig:18} % source ok
\end{figure}

Decent homes are defined by the Department of Communities and Local Government (DCLG) as homes that meet all the four following criteria: i) they meet the statutory minimum standards for housing; ii) are in reasonable state of repair, iii) have reasonably modern facilities and services, and iv) provide a reasonable level of thermal comfort. Figure \ref{Fig:18} plots the 2008-13 trends of houses failing these criteria in households where at least one person is over the age of 60. The overall levels of homes failing the decent homes criteria have fallen by over a third from 33.1 \% 2008 to 19.9 \% in 2013. This has mostly been due to more homes meeting the minimum standards and thermal comfort requirements. The number of homes failing the repair and modern facilities criteria have remained low and stable over this period. 

\begin{table}[hbtp!]
\caption{Percentage of houses failing the decent homes criteria – households occupied by an individual over 60 (see Figure \ref{Fig:18}). Source: Table DA3203 from the English Housing Survey \citep{DCLG2013}.}
\label{Tab:62}
\centering
\renewcommand{\arraystretch}{0.95}
...
\hline
& \multicolumn{6}{c}{\emph{Year}}\\
\cline{2-7}
\emph{Reason for failure} & 2008 & 2009 & 2010 & 2011 & 2012 & 2013 \\
\hline 
...
\psfrag{ltitle}[bl][bl]{\small{
\begin{tabular}{l}
\emph{Age of oldest}\\
\emph{person in household}
\end{tabular}
}}

\psfrag{a}[Bl][Bl]{\small{\emph{under 60}}}
\psfrag{b}[Bl][Bl]{\small{\emph{60 or more}}}
\psfrag{c}[Bl][Bl]{\small{\emph{75 or more}}}
...
\psfrag{x}[c][c]{\small{\emph{Age group (years)}}}
...
\hline
 & \multicolumn{4}{c}{\emph{Age group (years)}} \\
 \cline{2-5}
 & \multicolumn{1}{r}{16---24} & \multicolumn{1}{r}{25---49} & \multicolumn{1}{r}{50---64} & \multicolumn{1}{r}{over 65} \\ 
\hline 
\emph{Percent of workers working from home} &  5.1 & 12.3 & 18.3 & 38.3 \\ 
\hline
\end{tabularx}
\end{table}
...
\psfrag{tt}[bc][cc]{\small{\emph{Year}}}
\psfrag{80}[c][c]{\small{80}}
\psfrag{60}[c][c]{\small{60}}
\psfrag{40}[c][c]{\small{40}}
\psfrag{20}[c][c]{\small{20}}
...
\caption{Proportion of age group using a computer daily in Great Britain, 2006 and 2015. Source: Table 1 in \citet{ONS2015}}\label{Fig:19}%source ok
\end{figure}
...
\begin{table}[hbtp!]
\caption{Proportion of age group using a computer daily in Great Britain, 2006 and 2015 (see Figure \ref{Fig:19}). Source: Table 1 in \citet{ONS2015}.}
\centering
\begin{tabularx}\textwidth{p{3cm} *6{>{\centering\arraybackslash}X<{\enspace \%}}@{}}
  
\hline
  & \multicolumn{6}{c}{Age group (years)} \\
\cline{2-7} 
\emph{Year} & \multicolumn{1}{c}{16-24} & \multicolumn{1}{c}{25-34} & \multicolumn{1}{c}{35-44} & \multicolumn{1}{c}{45-54} & \multicolumn{1}{c}{55-64} & \multicolumn{1}{c}{65+} \\ 
  \hline
...
\psfrag{X}[cc][cc]{\small{\emph{Age group (years)}}}
\psfrag{Y}[cc][cc]{\small{\emph{Socio-economic group}}}
\psfrag{y}[c][c]{\small{\emph{Percent of people}}}

\includegraphics[width=\textwidth]{../figures/Fig7.2.eps}
\caption{Proportion of population with home internet access by age and socio-economic group 2012-15. Source: Table 4.63 in \citet{Ofco2015}.}\label{Fig:77}% Source OK
\end{figure}

85 \% of UK homes had access to the internet in 2015, a level that is still increasing, and is currently lowest in the older age groups with 65--74 year olds at 75 \% and over 75s at 40 \%. Access levels are higher in the ABC1 socio-economic groups at 92 \% and lowest in the DE groups at 70 \%, but increasing across the board\footnote{The classification is defined as follows: A, B and C1 are professionals, senior executives, middle management, and all other non-manual jobs such as nurses, salesmen, clerical workers; group C2 is specially qualified and skilled manual workers, foremen; groups D and E are semi-skilled and unskilled manual workers and those on the lowest levels of subsistence, casual workers and those dependent upon the state long-term.}.


\begin{table}[hbtp!]
\caption{Proportion of population with home internet access by age and socio-economic group 2012-15(see  Figure \ref{Fig:77}). Source - Table 4.63 in \citet{Ofco2015}.}\label{Tab:77}
\centering
\renewcommand{\arraystretch}{0.96}
\begin{tabularx}\textwidth{p{3cm} p{2cm} *4{>{\centering\arraybackslash}X<{\enspace \%}}@{}}
  \hline
  && \multicolumn{4}{c}{\emph{Year}}\\
  \cline{3-6}
&  & \multicolumn{1}{c}{2012} & \multicolumn{1}{c}{2013} & \multicolumn{1}{c}{2014} & \multicolumn{1}{c}{2015} \\ 
\hline
 \emph{UK} &  \emph{Total}  &  80 &  80 &  82 &  85 \\ 
 \hline
 \multirow{6}{*}{\emph{Age group (years)}}& 16 -- 24 &  90 &  91 &  94 &  91 \\ 
&  25 -- 34 &  90 &  91 &  92 &  94 \\ 
&  35 -- 54 &  88 &  90 &  89 &  94 \\ 
&  55 -- 64 &  75 &  79 &  78 &  82 \\ 
&  65 -- 74 &  64 &  56 &  67 &  75 \\ 
...
\psfrag{x}[c][c]{\footnotesize{\emph{Percentage of users}}}
\renewcommand{\arraystretch}{0.7}

\psfrag{Y}[bc][bc]{\footnotesize{
\begin{tabular}{c}
\emph{Age group}\\
\emph{(years)}
\end{tabular}}}
...
\caption{Proportion of of people using the internet for selected activities, by age group in Great Britain, 2015. Source: Table 7 in \citet{ONS2015}.}\label{Fig:20} %source ok
\end{figure}
...
\psfrag{5}[cc][cc]{\small{55 - 64}}
\psfrag{6}[cc][cc]{\small{over 65}}
\psfrag{tt}[cl][cl]{\small{\emph{Year}}}
...
\caption{Proportion of internet users making an online purchase within the past 12 months, by age group, in Great Britain, 2008 to 2015. Source: Table 10 in \citet{ONS2015}.}\label{Fig:21} %source ok
\end{figure}
...
\begin{table}[hbtp!]
\caption{Proportion of internet users making an online purchase within the past 12 months, by age group, 2008 to 2015 (see Figure \ref{Fig:21}). Source: Table 10 in \citet{ONS2015}.}\label{Tab:73}
\centering
\begin{tabularx}\textwidth{p{2cm} *8{>{\centering\arraybackslash}X<{\enspace \%}}@{}}

  \hline
  & \multicolumn{8}{c}{\emph{Year}}\\
  \cline{2-9}
\emph{Age group (years)} & \multicolumn{1}{c}{2008} & \multicolumn{1}{c}{2009} & \multicolumn{1}{c}{2010} & \multicolumn{1}{c}{2011} & \multicolumn{1}{c}{2012} & \multicolumn{1}{c}{2013} & \multicolumn{1}{c}{2014} & \multicolumn{1}{c}{2015} \\ 
  \hline
...
\begin{tabularx}\textwidth{p{3cm} *5{>{\centering\arraybackslash}X<{\enspace \%}}@{}}
  ...
  \hline
  & \multicolumn{5}{c}{\emph{Year}}\\
  \cline{2-6}
\emph{Age group (years)} & \multicolumn{1}{c}{2010} & \multicolumn{1}{c}{2011} & \multicolumn{1}{c}{2012} & \multicolumn{1}{c}{2013} & \multicolumn{1}{c}{2014}   \\ 
  \hline
...
\caption{Proportion condifent in specific internet skills, by lifestage in Britain, 2013. Source: \citet[][p. 18]{Dutt2013}.}\label{Fig:24}% Source OK
\end{figure}
...
\begin{table}[hbtp!]
\caption{Proportion condifent in specific internet skills, by lifestage in Britain, 2013 (see Figure \ref{Fig:24}). Source: \citet[][p. 18]{Dutt2013}.}\label{Tab:76}

\centering
\begin{tabularx}\textwidth{p{3cm} *4{>{\centering\arraybackslash}X<{\enspace \%}}@{}}
  \hline
  & \multicolumn{4}{c}{\emph{Internet skill}} \\
  \cline{2-5}
...
\begin{tabularx}\textwidth{p{3cm} *3{>{\centering\arraybackslash}X}@{}}
\hline
  &  \multicolumn{3}{c}{\emph{Percentage of pensioners}}\\
\cline{2-4}
&  \multicolumn{2}{c}{\emph{After housing costs}} & \\
\cline{2-3}
\emph{Year} &\emph{ Relative low income 60 \% median for that year} &\emph{ Absolute low income 60 \% 2010/2011 median} & \emph{Material deprivation }\\ 
  \hline
1998/99 &  29 &  39 &  \\ 
  1999/00 &  28 &  36 &  \\ 
  2000/01 &  26 &  32 &  \\ 
...
\psfrag{tt}[cl][cl]{\small{\emph{Age group (years)}}}
...
\caption{Quintile distribution of income (AHC - net equivalised disposable household income) for pensioners by age group, United Kingdom 2013/14. Source: \citet{DWP2015b}.}\label{Fig:82} % source ok
\end{figure}
...
\caption{Quintile distribution of income (AHC - net equivalised disposable household income) for pensioners by age group, United Kingdom 2013/14 (see Figure \ref{Fig:82}). Source: \citet{DWP2015b}.}\label{Tab:82}
\centering
\begin{tabularx}\textwidth{p{3cm} *5{>{\centering\arraybackslash}X<{ \%}}@{}}
  \hline
  & \multicolumn{5}{c}{\emph{Percentage of pensioners}} \\
  \cline{2-6}
\emph{Age group (years)} & \multicolumn{1}{c}{\emph{Bottom }} & \multicolumn{1}{c}{\emph{Second }} & \multicolumn{1}{c}{\emph{Middle }} & \multicolumn{1}{c}{\emph{Fourth }}& \multicolumn{1}{c}{\emph{Top }} \\ 
...
\psfrag{y}[c][c]{\small{\emph{Remaining life expectancy at 65 (years)}}}
...
\psfrag{B}[cl][cl]{\small{\emph{LE 2007-10}}}
\psfrag{C}[cl][cl]{\small{\emph{DFLE 2003-06}}}
\psfrag{D}[cl][cl]{\small{\emph{DFLE 2007-10}}}
...
In 2003-2006 men aged 65 living in the least deprived areas could expect to live 3.8 years longer than men living in the most deprived areas. By 2007-2010 this difference increased to 4.1 years. Similarly for women the difference was 3.1 years in the first period and increased to 3.5 in the second. In the same time life expectancy (LE) increased by around one year for all five deprivation levels and for both genders. 

The differences in life expectancy between men and women increase with level of deprivation from an advantage of around 2.5 years for women in the least deprived areas to an advantage of 3.1 in both periods in the most deprived areas. 
...
\caption{Remaining life expectancy (LE) and and disability free life expectancy (DFLE) in years, for men and women at age 65, by area deprivation quintile, 2003-06 and 2007-10, England (see Figures \ref{Fig:83} and \ref{Fig:28}). Source: \citet{ONS2013d}. }\label{Tab:83}
\centering
...
&\multicolumn{1}{c}{\emph{Area deprivation quintile}} & \multicolumn{1}{c}{\emph{LE}} & \multicolumn{1}{c}{\emph{DFLE}} & \multicolumn{1}{c}{\emph{LE}} & \multicolumn{1}{c}{\emph{DFLE}} \\ 
    \hline
...
\begin{tabularx}\textwidth{p{7cm} *3{>{\centering\arraybackslash}X}@{}}
 \hline
& \multicolumn{3}{c}{\emph{Selected UK regions}}\\
\cline{2-4}
\emph{Socio-economic classification} &	\emph{North East }& \emph{South East} & \emph{England and Wales}\\
 \hline
...
\psfrag{M}[c][l]{\footnotesize{\emph{Women}}}
\psfrag{m}[c][l]{\footnotesize{\emph{Men}}}
...
\centering
\begin{tabularx}\textwidth{p{0.5cm} p{0.5cm} p{5cm} *6{>{\centering\arraybackslash}X}@{}}
  \hline
&&&  \multicolumn{6}{c}{\emph{Years}}\\
 \cline{4-9}
&& \emph{Socio-economic group} & \emph{1982--1986} & \emph{1987-1991} & \emph{1992-1996} &\emph{1997-2001} & \emph{2002-2006}& \emph{2007-2011} \\ 
  \hline
\multirow{6}{*}{\rotatebox[origin=c]{90}{\emph{Gender}}}
...
\caption{Percentage of males and females with limiting long-term illness, by age and socioeconomic classification of household reference person (NS-SEC), 2007. Source: \citet{ONS2013a}.}\label{Fig:N07} %SourceOK
\end{figure}
...
\begin{table}[hbtp!]
\caption{Percentage of males and females with limiting long-term illness (LLTI), by age and socioeconomic classification of household reference person (NS-SEC), 2007 (see Figure \ref{Fig:N07}). Source: \citet{ONS2013a}.}\label{Tab:89}
\centering
\begin{tabularx}\textwidth{p{0.5cm} p{0.6cm} p{5cm} *4{>{\centering\arraybackslash}X<{\raggedleft \enspace \%}}@{}}

 \hline
&&& \multicolumn{4}{c}{\emph{Age group (years)}}\\
\cline{4-7}
& &\emph{Socio-economic classification} & \multicolumn{1}{r}{\emph{0 -- 15}} & \multicolumn{1}{r}{\emph{16 -- 44}} & \multicolumn{1}{r}{\emph{45 -- 64}} & \multicolumn{1}{r}{\emph{65+}} \\ 
\hline
\multirow{8}{*}{\rotatebox[origin=c]{90}{\emph{Gender}}}&   \multirow{3}{*}{\rotatebox[origin=c]{90}{\emph{Women}}} & \emph{Higher professional} &   4 &  10 &  19 &  40 \\ 
...
\psfrag{a}[c][c]{\small{\emph{Median Age (years)}}}
...
\begin{figure}[hbtp!]
\psfrag{tt}[l][l]{\small{\emph{Number of hours of unpaid care provided per week}}}
...
The proportion of people providing unpaid care work is 10.3 percent nationally, with high variability across ethnic groups as shown in Figure \ref{Fig:N12}. White British, Irish and Gypsy and Irish Traveller are most likely to provide care, while Mixed White and Black Africa, Chinese and Mixed White and Asian groups are about half as likely to provide care.  

\begin{table}[hbtp!]
\caption{Percentage of people with poor general health, median age and unpaid weekly care provision by ethnic group, England and Wales 2011 (see  Figures \ref{Fig:N10} and \ref{Fig:N12}). Source: \citet{ONS2013}.}\label{Tab:89}
\centering
...
\hline
\multicolumn{1}{c}{\emph{}}& \multicolumn{1}{c}{\emph{}}& \multicolumn{1}{c}{\emph{}}& \multicolumn{4}{c}{\emph{Providing unpaid care work}}\\
\multicolumn{1}{c}{\emph{}}& \multicolumn{1}{c}{\emph{}}& \multicolumn{1}{c}{\emph{}}& \multicolumn{4}{c}{\emph{(hours per week) }}\\
\cline{4-7}
...
\psfrag{x}[c][c]{\scriptsize{\emph{Percent reporting poor health}}}
...
\begin{tabularx}\textwidth{>{\hspace{-2pt}}p{0.2cm}<{\hspace{-15pt}}>{\hspace{-6pt}}p{2.4cm}<{\hspace{-15pt}} *8{>{\hspace{-6pt}\centering\arraybackslash}X<{\%}}@{}}
  \hline
&  & \multicolumn{8}{c}{\emph{Gender and age group (years)}}  \\
\cline{3-10}
&  & \multicolumn{4}{c}{\emph{Men}}  & \multicolumn{4}{c}{\emph{Women}}
\\
&\emph{Ethnic group}& \multicolumn{1}{c}{\emph{16--39}} &  \multicolumn{1}{c}{\emph{40--59}} &  \multicolumn{1}{c}{\emph{60--74}} &  \multicolumn{1}{c}{\emph{75+}} &  \multicolumn{1}{c}{\emph{16--39}} &  \multicolumn{1}{c}{\emph{40--59}} &  \multicolumn{1}{c}{\emph{60--74}} &  \multicolumn{1}{c}{\emph{75+}} \\ 
  \hline
...
\psfrag{tt}[c][c]{\small{\emph{Ethnic group}}}
...
\caption{Percentage of persons aged 60 years and over by (national) income quintile and ethnic group. Net unequivalised personal income and weighted data from the 1st (2009-2011) wave of the Understanding Society  survey. Source: \citet{UoE2015}. }\label{Fig:US03} %source ok
\end{figure}
...
\caption{Percentage of persons aged 60 and over by (national) income quintile and ethnic group. Net unequivalised personal income and weighted data from the 1st (2009-2011) wave of the Understanding Society  survey (see Figure \ref{Fig:US03}). Source: \citet{UoE2015}.}\label{Tab:US03}
\centering
\begin{tabularx}\textwidth{p{3cm} *5{>{\centering\arraybackslash}X<{ \%}}@{}}
  \hline
...
Across all but the oldest age group, women volunteer at higher rates than men, although these differences are only statistically significant in the 35---44 age group. The least likely to volunteer were people aged 25--44 and those 75 and over, while the highest levels are found in those aged 65-74. The main barriers to volunteering are work commitments and home and family commitments, while it is likely that health limitations are the main restriction on the volunteering ability of people over 75. 
...
\begin{tabularx}\textwidth{p{1.1cm} *7{>{\centering\arraybackslash}X<{ \%}}@{}}
  ...
  \hline
   & \multicolumn{7}{c}{Age group (years)}\\
   \cline{2-8}
\emph{Gender} & \multicolumn{1}{c}{\emph{18 --- 24 }}&  
...
\psfrag{tt}[c][c]{{\emph{Purpose of trip}}}
...
\emph{Purpose of trip} & \emph{2002} & \emph{2013} & \emph{2002} & \emph{2013}\\
  \hline
...
\psfrag{x}[c][c]{\footnotesize{\emph{Age group (years)}}}
...
\begin{tabularx}\textwidth{p{3cm} *2{>{\centering\arraybackslash}X<{ \%}}@{}}
  ...
  \hline
\emph{Age group (years)} & \multicolumn{1}{c}{\emph{Feeling lonely more than half,}} &  \multicolumn{1}{c}{\emph{Meeting socially}} \\ 
