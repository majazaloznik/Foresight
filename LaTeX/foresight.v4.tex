...
\begin{table}[hbtp!]
\caption{Proportion condifent in specific internet skills, by lifestage (see Figure \ref{Fig:24}). Source: \citet[][p. 18]{Dutt2013}.}\label{Tab:76}

\centering
\begin{tabularx}\textwidth{p{3cm} *4{>{\centering\arraybackslash}X<{\enspace \%}}@{}}
  \hline
  & \multicolumn{1}{c}{\emph{Internet skill}} \\
  \cline{2-5}
